...
![OSI Model](osi-model-7-layers.svg)
...
Internet Protocol Address is a unique address give to every computer connected to the Internet.
...
![IP addr and routing](IP%20addr%20and%20Routing.png)
...
![Packet Encapsilation](encapsilation_of_protocols.png)
